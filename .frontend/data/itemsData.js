...
const mockItems = [
  {
    ...
    mode: {
      ...
      wish: false,
      tradeMode: 'both',
      tradeSummary: '想換 PlayStation 5 或 Xbox Series X，也接受其他 Nintendo 主機相關商品'
    },
    pickup: {
      type: '面交',
      place: '台北市信義區',
    ...
    description: {
      main: 'Nintendo Switch OLED 白色主機，使用約一年，功能完全正常。',
      includes: [
        '主機本體（白色）',
        '原廠底座',
        '原廠充電器',
  ...
  },
  {
    ...
    description: {
      main: 'PlayStation 5 光碟版主機，全新未拆封，原廠保固。',
      includes: [
        'PS5 主機',
        'DualSense 無線控制器',
        'HDMI 線',
  ...
  },
  {
    ...
    images: [
      ...
      'https://via.placeholder.com/600x600/0064D2/FFFFFF?text=iPhone+3'
    ],
    description: {
      main: 'iPhone 13 Pro 256GB 深藍色，使用約一年半，功能完全正常。',
      includes: [
        'iPhone 13 Pro 主機',
        '原廠充電線',
        '原廠包裝盒',
